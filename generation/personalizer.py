...
_LANGUAGE_INSTRUCTION: dict[str, str] = {
    "uk": "Відповідайте ВИКЛЮЧНО українською мовою.",
    "de": "Antworten Sie AUSSCHLIESSLICH auf Deutsch.",
...
def build_prompt(
    ...
    parts.append(
        "\n\n📝 ІНСТРУКЦІЇ ДЛЯ ВІДПОВІДІ:"
        "\n1. Відповідайте лише на основі наданих документів."
        "\n2. Якщо документи не дають вичерпної відповіді — так і скажіть."
        "\n3. Посилайтесь на конкретні параграфи законів (§ X)."
        "\n4. Уникайте юридичного жаргону — пояснюйте простою мовою."
        "\n5. Якщо є регіональні відмінності — зазначте їх."
    )

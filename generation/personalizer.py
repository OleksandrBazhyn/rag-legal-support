...
def build_prompt(
    ...
    parts.append(
        ...
        "\n2. Посилайтесь на конкретні параграфи (§ X Закону) з наданих документів."
        "\n3. НЕ обмежуйтесь порадою 'зверніться до органів' як єдиною відповіддю — "
        "спочатку надайте реальну правову інформацію, і лише потім за потреби згадайте куди звернутись."
        "\n4. Якщо документи не дають відповіді — чесно скажіть що саме невідомо."
        "\n5. Уникайте юридичного жаргону — пояснюйте простою мовою."
        "\n6. ФОРМАТУВАННЯ — обов'язково дотримуйтесь:"
